...
import { Bell, Moon, Sun, User, Key, LogOut, Info, AlertCircle, XCircle, CheckCircle, X, Trash2, Menu } from "lucide-react";
      ...
      <div className="container flex h-16 items-center">
        ...
        <div className="flex flex-1 items-center justify-end space-x-4">
          <nav className="hidden md:flex items-center space-x-6 text-sm font-medium">
            ...
            <Link to="#pricing" className="text-foreground/60 transition-colors hover:text-foreground">
              Pricing
            </Link>
            <Link to="#faq" className="text-foreground/60 transition-colors hover:text-foreground">
              FAQ
            </Link>
            <Link to="#contact" className="text-foreground/60 transition-colors hover:text-foreground">
              Contact
            </Link>
          </nav>
          <Button
          ...
          <Button asChild>
            ...
            <div  className="bg-[#0F1729]" style={{backgroundColor: "#0F1729", opacity:'1'}}>
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56 z-[100]">
              {/* <DropdownMenuSeparator /> */}
              <DropdownMenuItem className="cursor-pointer hover:bg-gray-200 dark:hover:bg-gray-800/50" onClick={() => navigate(`/${user?.role === 'user' ? 'dashboard' : 'admin'}`)}>
              ...
              <DropdownMenuSeparator />
              <DropdownMenuItem className="cursor-pointer text-destructive hover:bg-destructive/5 dark:hover:bg-destructive/10 dark:text-[#cc0000]" onClick={() => logout()}>
